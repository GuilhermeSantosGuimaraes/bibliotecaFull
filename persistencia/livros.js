...
async function inserir(livro){
    ...
    const sql = await cliente.query("INSERT INTO livros(isbn, titulo, editora, autor, anopubli, disponibilidade) VALUES($1, $2, $3, $4, $5, $6) RETURNING*", [livro.isbn, livro.titulo, livro.editora, livro.autor, livro.anopubli, livro.disponibilidade]);
